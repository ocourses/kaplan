...
3. **Exercice 3** :
   - Considérez le système affine suivant et trouvez sa solution :
...
Ces exemples et exercices permettent de pratiquer le calcul de l'exponentielle de matrices et d'analyser le comportement des systèmes dynamiques linéaires.

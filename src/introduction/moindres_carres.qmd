...
<img class="centering" width="40%" style="float: right; max-width:500px; min-width:200px" src="../../assets/julia/approximation_lineaire.gif"/>

L'idée principale de l'alogrithme de Gauss-Newton est de résoudre à chaque itération un problème aux moindres carrés linéaire. Notons $\theta_k$ l'itéré courant. Nous pouvons approcher pour chaque instant $t_i$ la prédiction $\theta \mapsto x(t_i, \theta)$ par son approximation linéaire au voisinage du point courant $\theta_k$ :

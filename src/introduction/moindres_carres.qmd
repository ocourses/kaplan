...
<div class="freezeframe" width="40%" style="float: right; max-width:360px; min-width:200px">
   <img class="approximation_lineaire" src="../../assets/julia/approximation_lineaire.gif"/>
</div>
<script>
const ff_al = new Freezeframe({
   selector: '.approximation_lineaire',
   trigger: 'click',
   overlay: true
});
</script>
...
<div class="centering freezeframe" width="60%" style="max-width:450px; min-width:300px">
   <img class="approximation_moindres_carres" src="../../assets/julia/approximation_moindres_carres.gif"/>
</div>
<script>
const ff_amc = new Freezeframe({
   selector: '.approximation_moindres_carres',
   trigger: 'click',
   overlay: true
});
</script>

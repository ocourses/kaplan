...
<div class="centering" style="max-width:900px; min-width:300px; object-fit:fill; width:100%;">
   <video width="100%" height="100%" controls autoplay muted loop>
      <source src="../../assets/julia/approximation_lineaire.mp4" type="video/mp4">
   </video>
</div>
...
<div class="centering" style="max-width:900px; min-width:300px; object-fit:fill; width:100%;">
   <video width="100%" height="100%" controls autoplay muted loop>
      <source src="../../assets/julia/approximation_moindres_carres.mp4" type="video/mp4">
   </video>
</div>

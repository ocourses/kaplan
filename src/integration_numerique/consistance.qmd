...
\begin{aligned}
E(h) &= x(t_0 + h) - x_0 - h \, \Phi(t_0, x_0, h) \\
&= x'(t_0)\, h + \grandO{h^2} - h \, f(t_0, x_0) \\
&= h\, f(t_0, x_0) - h \, f(t_0, x_0) + \grandO{h^2} \\
&= \grandO{h^2}.
\end{aligned}
$$
...
$$
x(t_0 + h) - x_0 = hx'(t_0) + \frac{h^2}{2} x''(t_0) + \grandO{h^3}
$$
...
\left( \frp{f}{t}(t_0, x_0) + \frp{f}{x}(t_0, x_0) \, f(t_0, x_0) \right) + \grandO{h^3}.
$$

D'un autre côté, nous avons

$$
k_2(h) = f(t_0, x_0) + h\, f'(t_0, x_0) \cdot (c_2, a_{21} k_1) + \grandO{h^2}.
$$
...
\left( \frp{f}{t}(t_0, x_0) + \frp{f}{x}(t_0, x_0) \, f(t_0, x_0) \right) \\[0.5em]
& \quad - h \left( b_1 f(t_0, x_0) + b_2 f(t_0, x_0) + b_2 h\, f'(t_0, x_0) \cdot (c_2, a_{21} k_1) \right)
+ \grandO{h^3} \\[0.5em]
&= h (1-b_1-b_2) f(t_0, x_0) \\[0.5em]
&\quad + \frac{h^2}{2} (1 - 2 b_2 c_2) \frp{f}{t}(t_0, x_0)
+ \frac{h^2}{2} (1 - 2 b_2 a_{21}) \frp{f}{x}(t_0, x_0)\, f(t_0, x_0) + \grandO{h^3}.
\end{aligned}
$$
